...
// import { CheckCircle, Clock, UserCheck, Trash2 } from 'lucide-react';
...
//                       )}
//                     </td> */}
//                     <td style={{ padding: '16px 20px', display: 'flex', gap: '8px', alignItems: 'center' }}>
//                       {!user.isApproved && (
//                         <button
//                           onClick={() => approveUser(user._id)}
//                           disabled={actionId === user._id}
//                           style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '8px 14px', borderRadius: '10px', background: '#111', color: 'white', border: 'none', cursor: 'pointer', fontSize: '12px', fontWeight: '700', fontFamily: 'inherit', opacity: actionId === user._id ? 0.6 : 1 }}
//                         >
//                           <UserCheck size={13} />
//                           {actionId === user._id ? 'Approving...' : 'Approve'}
//                         </button>
...
//                           style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '8px 14px', borderRadius: '10px', background: '#fff', color: '#dc2626', border: '1px solid #fecaca', cursor: 'pointer', fontSize: '12px', fontWeight: '700', fontFamily: 'inherit' }}
//                         >
                  ...
                  <tr key={user._id} style={{ borderBottom: i < users.length - 1 ? '1px solid #f0ece6' : 'none' }}>
                    ...
                    <td style={{ padding: '16px 20px' }}>
                      <select
                        ...
                        style={{ fontSize: '12px', border: '1px solid #e0dad0', borderRadius: '8px', padding: '5px 8px', background: 'white', fontFamily: 'inherit', cursor: user.role === 'super_admin' ? 'not-allowed' : 'pointer' }}
                      >
                        {ROLES.map((r) => <option key={r} value={r}>{r.replace('_', ' ')}</option>)}
                      </select>
                    </td>
                    ...
                    {/* Actions — fixed: no display:flex on <td>, use a wrapper div instead */}
                    <td style={{ padding: '16px 20px' }}>
